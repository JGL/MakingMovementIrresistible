...
class Boid {
  ...
  flock(boids) {
    ...
    //also seek towards the mouse pointer
    let mousePosition = createVector(mouseX, mouseY);
    let mouseSeek = this.seek(mousePosition);
    mouseSeek.mult(0.8);
  ...
  render() {
    ...
    let alphaDColour = color(flyColour);
    if (debugDraw) {
    ...
    push();
    ellipse(this.position.x, this.position.y, flySize, flySize);
    pop();
  }
